...
- [x] 1. Thiết lập cấu trúc dự án và khung kiểm thử
...
- [x] 2. Implement Board module
  - [x] 2.1 Implement `src/board.py` — Board class
  ...
  - [x]* 2.2 Viết unit tests cho Board
...
- [x] 3. Implement WinChecker module
  - [x] 3.1 Implement `src/win_checker.py` — WinChecker + GameResult
  ...
  - [x]* 3.2 Viết unit tests cho WinChecker
...
- [x] 5. Implement Renderer module
  - [x] 5.1 Implement `src/renderer.py` — Color constants + Renderer
  ...
  - [x]* 5.2 Viết unit tests cho Renderer
...
- [x] 6. Implement InputHandler module
  - [x] 6.1 Implement `src/input_handler.py` — InputHandler
